...
class Employees extends Person{
	...
	Employees(){}
	Employees(String name,String gender,String address,int age,int empid,int salary,String companyname,String qualification){
...
class TeacherT extends Employees{
	int teacherid;
	String department,subject;
	TeacherT(){}
	TeacherT(String name,String gender,String address,int age,int empid,
		int salary,String companyname,String qualification,int teacherid,String department,String subject){
