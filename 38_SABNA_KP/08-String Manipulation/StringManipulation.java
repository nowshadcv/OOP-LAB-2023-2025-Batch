...
public class StringManipulation {
	public static void main(String[] args){ char arrSample[] = { 'R', '0', 'S', 'E'};
			...
			System.out.println( "Length of" + strSample1 +" is: " + strSamplel.length());
			...
			String strSample3 strSample1.concat(strSample2); System.out.print(strSample3+ "\t");
			...
			System.out.println("RockStar starts with 'Ro':" + strSample.startsWith("Ro")); System.out.println("RockStar ends with 'Star':" + strSample.endsWith("Star"));
			...
			System.out.println("Index of 'Star' in RockStar: "+strSample.indexOf("Star")); System.out.println("All caps RockStar: strSample.toUpperCase());

			System.out.println("All small RockStar: strSample.toLowerCase()); System.out.println("Replace Star with et: "+strSample.replace("Star", "et"));
			...
			System.out.println( "Double value of oval is Double.valueOf(dval)); System.out.println( "Integer value of ival is: +Integer.valueOf(ival));double a Double.valueOf(dVal); int b Integer.valueOf(iVal); System.out.println(a+b);
