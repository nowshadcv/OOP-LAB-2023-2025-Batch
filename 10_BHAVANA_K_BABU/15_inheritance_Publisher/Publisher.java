...
System.out.println("Name: "+super.name); System.out.println( "Type :"+this.Lit_type);

System.out.println ("Publisher "+ this.publisher.publisher);}}
 class inheritancepublisher {

public static void main(String[] args){

Publisher ip= new Publisher ("S. Chand");

Literature i= new Literature ("As you like it", ip);

i. display();

Publisher fp =new Publisher ("Tata McGraw Hill");

Fiction f= new Fiction ("Tempest", ip); 
f. display();}}
